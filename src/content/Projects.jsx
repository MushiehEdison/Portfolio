    ...
    <div className="fixed inset-0 bg-gradient-to-br from-gray-800 to-gray-900 overflow-y-auto">
      ...
      <div className="min-h-full w-full flex items-center justify-center px-4 sm:px-8 md:px-16 lg:px-32 py-20 sm:py-24">
        <div className="max-w-4xl w-full">
          ...
          {project.links && (
            <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-6 sm:p-8">
              <h2 className="text-white font-mono font-bold text-lg sm:text-xl mb-4 text-center">
                Live Projects
              </h2>
              <div className="flex flex-col gap-3">
                {project.links.map((link, index) => (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block bg-white text-gray-800 font-mono font-bold text-sm sm:text-base px-6 py-3 rounded-lg hover:bg-opacity-90 transition-all text-center"
                  >
